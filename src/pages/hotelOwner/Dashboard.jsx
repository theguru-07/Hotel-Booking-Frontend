...
const Dashboard = () => {
  ...
  return (
    <div>
      <Title align='left' font='poppins' title='Dashboard' subTitle='Moniter your room listings, track bookings and analyze revenue-all in one place. Stay updated with real time insights to ensure smooth operations.'/>

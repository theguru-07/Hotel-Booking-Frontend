    ...
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        <div>
            <div className='flex flex-col items-start text-left'>
                <h1 className='font-montserrat text-4x1 md:text-[40px]'>Hotel Rooms</h1>
                <p className='text-sm md:text-base text-gray-500/90 mt-2'>Take Advantage of our limited-time offer and special packages to enhance your stay and create unforgettable memories.</p>
            </div>
            ...
            {roomsDummyData.map((room)=>(
                <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last-border-0'>
                    ...
                    <div className='md:w-1/2 flex flex-col gap-2'>
                        ...
                        className='text-gray-800 text-3x1 font-poppins cursor-pointer'>{room.hotel.name}</p>
        ...
        <div className='bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 lg:mt-16'>
            ...
            <div className='px-5 pt-5'>
                <p className='font-medium text-black-800 pb-2'>Sort by</p>
